...
if not os.path.exists(f"{analysis_dir}/survival"):
    ...
    print(f"[SUCCESS] Created analysis/survival directory: {analysis_dir}/survival")
else:
    print(f"[SUCCESS] Analysis survival directory already exists.")
...
if not os.path.exists(f"{figures_dir}/models"):
    ...
    print(f"[SUCCESS] Created figures/models directory: {figures_dir}/models")
else:
    print(f"[SUCCESS] Figures models directory already exists.")


# Check existence of figures/one_off directory
if not os.path.exists(f"{figures_dir}/one_off"):
    os.makedirs(f"{figures_dir}/one_off")
    print(f"[SUCCESS] Created figures/one_off directory: {figures_dir}/one_off")
else:
    print(f"[SUCCESS] Figures one_off directory already exists.")
